...
const {
    botName,"Dims :(",
    ownerName,"Owner Ganteng",
    BarBarKey,"A4wJwkoSak82hj82NWo92",
    ownerNumbers,"6285809535507@s.whatsapp.net",
    languages,"ind",
    botPrefix,"."
    memberLimitss,"25",
    userDefaultLimit"30"
...
async function starts() {
	...
	nzwa.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = [085809535507]
			const nomorOwner = [085809535507]
			...
			const isOwner = 085809535507.includes(sender)
                        const isLevelingOn = isGroup ? _leveling.includes(groupId) : false
                        const NomerOwner = '085809535507@s.whatsapp.net'
